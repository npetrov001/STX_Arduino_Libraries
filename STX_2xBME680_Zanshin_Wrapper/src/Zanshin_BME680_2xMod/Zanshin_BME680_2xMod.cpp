/*! @file Zanshin_BME680_2xMod.cpp
    ...
    !!! Added begin2() for STX_2xBME680_Zanshin_Wrapper so that I2C can be on non-default pins
*/

#include "Zanshin_BME680_2xMod.h"  // Include the library header definition
...
// start for STX_2xBME680_Zanshin_Wrapper
bool BME680_Class::begin2(uint8_t i2c_addr)
{
    // Check whether device responds at this address
