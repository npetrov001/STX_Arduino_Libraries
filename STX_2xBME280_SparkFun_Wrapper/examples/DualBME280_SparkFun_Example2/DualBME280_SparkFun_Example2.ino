/* 2xBME280 example using SparkFun Wrapper */
...
STX_2xBME280_SparkFun_Wrapper DualBME280;
...
void setup()
{
    ...
    Serial.printf("Starting 2xBME280 via SparkFun Wrapper... ms=%ld\r\n", millis());
    ...
    if (DualBME280_Started)
    {
        ...
        Serial.printf("Humidity Calibration #1: %d %d %d %d %d %d\r\n",
                      DualBME280.sensor1.calibration.dig_H1,
                      DualBME280.sensor1.calibration.dig_H2,
                      DualBME280.sensor1.calibration.dig_H3,
                      DualBME280.sensor1.calibration.dig_H4,
                      DualBME280.sensor1.calibration.dig_H5,
                      DualBME280.sensor1.calibration.dig_H6);
        Serial.printf("Humidity Calibration #2: %d %d %d %d %d %d\r\n",
                      DualBME280.sensor2.calibration.dig_H1,
                      DualBME280.sensor2.calibration.dig_H2,
                      DualBME280.sensor2.calibration.dig_H3,
                      DualBME280.sensor2.calibration.dig_H4,
                      DualBME280.sensor2.calibration.dig_H5,
                      DualBME280.sensor2.calibration.dig_H6);
    }
}
