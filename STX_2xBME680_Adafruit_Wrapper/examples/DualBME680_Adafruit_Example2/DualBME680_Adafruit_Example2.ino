/* 2xBME680 example using Adafruit Wrapper */
...
STX_2xBME680_Adafruit_Wrapper DualBME680;
...
void setup()
{
    ...
    Serial.printf("Starting 2xBME680 via Adafruit Wrapper... ms=%ld\r\n", millis());
...
void loop()
{
    if (DualBME680_Started)
    {
        ...
        dtostrf(DualBME680.Tdiff.avg_diff, 4, 2, sDiffT);
        dtostrf(DualBME680.Hdiff.avg_diff, 4, 2, sDiffH);
        ...
        sprintf(sMsg, 
                ...
                "Diffs: T=%s H=%s P=%d G=%d - OK: Last=%d, Total=%d", 
                read_seq, sT1, sH1, sT2, sH2, p1, p2,
                DualBME680.GasValid(), g1, g2,
	            sDiffT, sDiffH, (int)(DualBME680.Pdiff.avg_diff), (int)(DualBME680.Gdiff.avg_diff),
	            DualBME680.DiffToleranceOK_Last(), DualBME680.DiffToleranceOK_Total());
